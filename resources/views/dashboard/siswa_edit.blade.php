...
<div class="card my-5">
    <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
        <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
            <h6 class="text-white text-capitalize ps-3">Form Update Data Siswa</h6>
        </div>
    </div>
    <div class="card-body px-4 pb-2">
        <form action="{{ url('siswa/'.$user->user_id.'/'.$user->id) }}" method="POST"
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <div class="input-group input-group-outline my-3">
                        <input value="{{ $user->nama_ayah }}" name="nama_ayah" type="text" class="form-control">
                    </div>
                </div>
                <div class="col-md-4">
                    <label class="form-label">Nama Ibu</label>
                    <div class="input-group input-group-outline my-3">
                        <input value="{{ $user->nama_ibu }}" name="nama_ibu" type="text" class="form-control">
                    </div>
                </div>
            </div>
            <div class="row">
            ...
            <div class="row my-4">
                <div class="col-md-4">
                    ...
                    <a href="{{ route('siswa') }}" type="reset" class="btn btn-secondary">Kembali</a>
                </div>
            </div>
        </form>
    </div>
