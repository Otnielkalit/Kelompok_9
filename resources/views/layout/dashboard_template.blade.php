...
<aside
    ...
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href="/">
            ...
            <span class="ms-1 font-weight-bold text-white">Little Star</span>
        </a>
    </div>
    ...
    <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link text-white {{ Route::currentRouteName() === 'guru' ? 'active bg-gradient-primary' : '' }}"
                    href="/guru">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="material-icons opacity-10">account_circle</i>
                    </div>
            ...
            <li class="nav-item">
                <a class="nav-link text-white {{ Route::currentRouteName() === 'poin_penilaian' ? 'active bg-gradient-primary' : '' }}"
                    href="/poin-penilaian" id="penilaian">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
