...
<div>
    <p style="font-size: 16px; font-weight: bold;"><span>Nama Anak : </span> {{$siswa->nama}}</p>
    <p style="font-size: 16px; font-weight: bold;"><span>NISN : </span> {{$siswa->nisn}}</p>
</div>
<table style="width: 100%; border: 1px solid #aaa; border-collapse: collapse;">
    <thead>
        <tr>
            <th style="border: 1px solid #aaa; padding: 10px;" scope="col">Tanggal</th>
    ...
    <tbody>
        ...
        <tr>
            <td style="border: 1px solid #aaa; padding: 7px;">{{ $item->created_at }}</td>
